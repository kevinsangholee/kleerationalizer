...
var $author$project$Rationalizer$AddedIngred = function (a) {
	return {$: 'AddedIngred', a: a};
};
var $author$project$Rationalizer$UpdatedNewIngred = function (a) {
	return {$: 'UpdatedNewIngred', a: a};
};
...
var $author$project$Rationalizer$Ingred = function (a) {
	return {$: 'Ingred', a: a};
};
...
var $author$project$Rationalizer$parseIngredient = function (toParse) {
	var parts = $elm$core$Array$fromList(
		A2($elm$core$String$split, ' ', toParse));
	var name = ($elm$core$Array$length(parts) === 2) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
		A3(
			$elm$core$List$foldr,
			...
			A2(
				...
				$elm$core$Array$toList(
					A3(
						...
						parts)))));
	return $author$project$Rationalizer$Ingred(
		{
			ingredMeasurement: A2(
...
var $author$project$Rationalizer$ingredForm = F2(
	function (ingredText, ingredValid) {
		var displaySetting = ingredValid ? 'none' : 'block';
		var changeIngred = function (newString) {
			return $author$project$Rationalizer$UpdatedNewIngred(newString);
		};
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(ingredText),
							$elm$html$Html$Events$onInput(changeIngred)
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$disabled(!ingredValid),
							$elm$html$Html$Events$onClick(
							$author$project$Rationalizer$AddedIngred(
								$author$project$Rationalizer$parseIngredient(ingredText)))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'display', displaySetting)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Ingredient not valid!')
						]))
				]));
	});
...
var $author$project$Rationalizer$ingredToString = function (ing) {
	var ingred = ing.a;
	var _v1 = ingred.ingredName;
	if (_v1.$ === 'Nothing') {
		return $elm$core$String$fromFloat(ingred.ingredQuantity) + (' ' + ingred.ingredMeasurement);
	} else {
		var name = _v1.a;
		return $elm$core$String$fromFloat(ingred.ingredQuantity) + (' ' + (ingred.ingredMeasurement + (' ' + name)));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Rationalize Your Recipes!')
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
